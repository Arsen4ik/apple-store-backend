...
var getActions_1 = require("./utils/actions/getActions");
...
router.get('/category', function (_, res) { return __awaiter(void 0, void 0, void 0, function () {
    var data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, getActions_1.getAllCategories)()];
            case 1:
                data = _a.sent();
                res.json(data);
                return [2 /*return*/];
